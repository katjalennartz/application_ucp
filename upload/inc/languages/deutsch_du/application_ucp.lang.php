...
$l['application_ucp_trigger'] = 'Gebe hier mögliche Inhaltswarnungen für das Profil ein.';
...
$l['application_ucp_readybtn_prewob'] = 'Zwischenwob einreichen';
$l['application_ucp_ucp_modinfo'] = ' Dein Steckbrief wird von {1} korrigiert.';
$l['application_ucp_ucp_correction'] = ' <span class="need_correction">Dein Steckbrief muss von dir überarbeitet werden. Bei Rückfragen melde dich gerne beim Team.</span>';
$l['application_ucp_ucp_hasprewob'] = '<br><span class="prewob_yes">Du hast dein Zwischen Wob</span>.';
$l['application_ucp_ucp_waitingwob'] = '<br><span class="waiting">Du hast deinen Steckbrief zum endgültigen WOB eingereicht</span>.';
...
$l['application_ucp_index_nomod_wob'] = 'Dein Steckbrief wurde noch nicht übernommen.';

$l['application_ucp_index_token'] = "Dein Steckbrief wurde von {1} übernommen.";
$l['application_ucp_index_tokenwob'] = 'Dein Steckbrief wurde von {1} übernommen und wartet auf sein WoB. Bei Rückfragen melde dich gerne beim Team.';
$l['application_ucp_index_correction'] = "Für deinen Steckbrief wurde von {1} eine Korrektur angefordert.";
$l['application_ucp_index_prewobyes'] = 'Du hast dein Zwischen WoB erhalten. Finalisiere deinen Steckbrief und reiche ihn ein.';
